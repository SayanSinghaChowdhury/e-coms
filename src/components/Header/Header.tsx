...
const Header = () => {
	...
	return (
		<header
			className={`fixed top-0 right-0 left-0 z-50 mx-auto backdrop-blur-md transition-all duration-300 duration-[1.2s] ease-out ${
				isScrolled
			...
			<div className="mx-auto flex h-14 w-full max-w-[1280px] items-center justify-between px-4 md:h-16 md:px-6">
				...
				<nav className="hidden items-center gap-6 md:flex">
					...
					<Link
						className="flex place-items-center gap-2 font-sans font-semibold duration-150 hover:text-yellow-300"
						href="/"
						target="-_blank">
						<h1>Sign In</h1>
						<LayoutGridIcon />
